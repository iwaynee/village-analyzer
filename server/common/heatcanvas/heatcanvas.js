...
HeatCanvas.prototype.render = function(step, degree, f_value_color) {
    ...
    this.worker.on('message', e => {
        self._runCounter--;
        self.value = e.value;
        self._valueWidth = e.width;
        self._valueHeight = e.height;
...
HeatCanvas.prototype._createWorker = function() {
    this.worker = new Worker("./common/heatcanvas/heatcanvas-worker.js");
    this._runCounter = 0;
};
...
defaultValue2ColorResult[3] = 1;// a
